...
**작성자**: Claude Code
**검토 필요**: 시간외근무수당 단가, 성과상여금 등급별 비율, 보험료 계산식
**버전**: 1.0
**최종 수정일**: 2025-10-08
