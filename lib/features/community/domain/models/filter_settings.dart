...
class FilterSettings extends Equatable {
  ...
  static FilterSettings fromMap(Map<String, Object?> data) {
    return FilterSettings(
      allowedSerials:
          (data['allowedSerials'] as List<dynamic>?)?.cast<String>() ?? [],
      blockedSerials:
          (data['blockedSerials'] as List<dynamic>?)?.cast<String>() ?? [],
      allowedTracks: ((data['allowedTracks'] as List<dynamic>?) ?? [])
          .cast<String>()
          .map(
            (name) => CareerTrack.values.firstWhere(
      ...
      blockedTracks: ((data['blockedTracks'] as List<dynamic>?) ?? [])
          ...
          .toList(),
      allowedRegions:
          (data['allowedRegions'] as List<dynamic>?)?.cast<String>() ?? [],
      blockedRegions:
          (data['blockedRegions'] as List<dynamic>?)?.cast<String>() ?? [],
