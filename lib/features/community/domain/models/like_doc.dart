class LikeDoc {
  const LikeDoc({required this.id, required this.postId, required this.uid, required this.createdAt});
  ...
  LikeDoc copyWith({String? postId, String? uid, DateTime? createdAt}) => LikeDoc(
        id: id,
